...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-60 h-full overflow-hidden border-r border-slate-700/80 bg-[#142238]/80 backdrop-blur-md flex flex-col justify-between shrink-0 select-none sidebar-depth">
